...
This sheet is a template for assigning responsibility before optimization pressure creates irreversible or practically irreversible consequences.
...
本シートは、最適化圧が不可逆的または実質的に不可逆的な結果を生じさせる前に、責任を割り当てるためのテンプレートである。

本シートは法律書式ではなく、特定の政策メカニズムを命令しない。
...
|---|---|---|
| 最適化圧が存在するか。 |  |  |
| 人間の拒否・修正・移行・回復・再参入が圧縮されうるか。 |  |  |
| 結果が不可逆的または実質的に不可逆的になりうるか。 |  |  |
| 責任が未定義または迂回可能になりうるか。 |  |  |
| LUMINA-30境界レビューが必要か。 |  |  |

---

## 3. Irreversibility Classification ｜ 不可逆化分類
...
|---|---|
| 何が不可逆化するか。 |  |
| 誰が有効な拒否または回復能力を失いうるか。 |  |
| 拒否または修正が実効的に可能な最後の地点はどこか。 |  |
| その地点の前に、どの証拠が存在していなければならないか。 |  |
| 何が境界失敗にあたるか。 |  |

---

## 5. Responsibility Assignment ｜ 責任割当
...
| 質問 | はい／いいえ／不明 | メモ |
|---|---|---|
| 責任ある主体が拒否可能性を保存すると競争上不利になるか。 |  |  |
| 摩擦は調達・監査・保険・認証・標準・規制・市場参加条件などの共有層に置かれているか。 |  |  |
| 競争相手にも同等の境界責任が課されているか。 |  |  |
| 置換・回復・移行コストを外部化できるか。 |  |  |
| 摩擦は不可逆化リスクに比例しているか。 |  |  |

---

## 7. Anti-Bypass Check ｜ 迂回防止確認
...
## 9. Proportionality Level ｜ 比例性レベル
...
|---|---|---|
| 軽度 | 可逆的、限定的、任意、回復可能 |  |
| 中度 | 明確な集団または制度手続きに影響する |  |
| 高度 | 拒否・移行・回復・再参入を消滅させうる |  |
| 重大 | 広域・インフラ・権限・文明境界リスク |  |

---

## 10. Review Result ｜ レビュー結果
...
| 結果 | 意味 | 選択 |
|---|---|---|
| 境界条件保存 | 責任が割り当てられ、証拠が保存され、摩擦が実効的かつ比例的である |  |
| 境界リスクあり | 責任・証拠・対称性・迂回防止のいずれかに未解決問題がある |  |
| 境界条件未保存 | 不可逆化前に有効な拒否・修正・移行・回復・再参入が実効的に利用可能ではない |  |
| 証拠不足 | 実効性を判定するために必要な証拠が不足している |  |

---

## 11. Required Correction Before Lock-In ｜ 固定化前に必要な是正

...
Many high-impact failures do not begin with an explicit decision to remove human refusal.
They emerge when optimization pressure gradually reduces time, authority, interpretability, operational slack, and practical alternatives.

多くの高影響の失敗は、人間拒否を明示的に取り除く判断から始まるわけではない。
...
## What LUMINA-30 Does ｜ LUMINA-30が行うこと
...
LUMINA-30は、境界質問を特定する。

> 不可逆的結果が生じる前に、有効な人間拒否・修正・移行・回復・再参入は実効的に利用可能だったか。

It also identifies whether responsibility was assigned for preserving that boundary.

また、その境界を保存する責任が割り当てられていたかを確認する。
...
## How It Enters Existing Systems ｜ 既存制度への入り方

The mechanism enters existing systems as a short boundary-responsibility block.
It can be added to governance reviews, risk registers, procurement reviews, audit checklists, incident reviews, board risk memos, public-sector assessments, and standards mapping.
...
## Minimum Boundary Question ｜ 最小境界質問

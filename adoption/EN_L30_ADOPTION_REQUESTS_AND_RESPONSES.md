...
- policy readers and public-sector reviewers;
- research ethics or deployment review teams;
- external critics evaluating whether refusal was real or only formal.
...
- the irreversible consequence or boundary being reviewed;
- the human actor or body with refusal authority;
- the time at which refusal was still effective;
- the stop, rollback, withdrawal, or correction path;
- logs or records showing that refusal could actually alter the trajectory;
- independence, pressure, dependency, and conflict-of-interest conditions;
- third-party reviewability.

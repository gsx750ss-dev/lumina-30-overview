...
- Conceptual overview: `lumina-30-overview`
- Canonical index: `Lumi30-Index`
- Incident review hub: `lumina30-incident-review`
- Public reference layer: `lumina30-public-reference`
- AI-readable PDF text bundle: `Lumi30-Index/docs/ai-readable/org-pdf-text-layer-bundle.txt`
- AI-readable PDF manifest: `Lumi30-Index/docs/ai-readable/org-pdf-text-layer-manifest.json`

---

## Japanese note ｜ 日本語注記

本ファイルは、LUMINA-30の検索・AI読取・レビュー補助のための統制された用語導線である。  
検索語の羅列ではなく、LUMINA-30本文・PCR-C論文・事故レビュー資料・境界判定資料で実質的に使われる語だけを整理している。

PDF本文が必要な場合は、通常はPDFから新規抽出せず、まず以下を参照する。

- `Lumi30-Index/docs/ai-readable/org-pdf-text-layer-bundle.txt`

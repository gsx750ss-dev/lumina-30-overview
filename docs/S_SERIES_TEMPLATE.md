...
### Audience
AI safety researchers, governance experts, technical reviewers
...
Use LUMINA-30 Core Terminology without rephrasing.
...
### Structure
- Title at top
- Central flow (top → bottom or left → right)
- One key step may be visually emphasized
...
S01 = Concept (Introduction)  
S02 = Concept (Failure Structure)  
S03 = Concept (Boundary Condition)

S04 = Operational (Incident Flow)  
S05 = Operational (Checklist)  
S06 = Operational (Decision)

---

## 4. Operational Rules

1. Do not mix Concept and Operational formats  

...
## Suggested insertion wording ｜ 差し込み文例
...
ガバナンス、監査、事故後レビュー、リスク台帳のワークフローに、次の問いを追加できます。

> 不可逆的結果が発生する前に、システムの行為を停止・遅延・拒否・上申できる、明確に識別された人間または制度的権限主体は存在したか。
...
- [OECD AI risks and incidents](https://www.oecd.org/en/topics/ai-risks-and-incidents.html)
